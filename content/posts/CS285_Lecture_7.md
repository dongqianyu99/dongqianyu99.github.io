...
{{< figure src="/images/CS285/Lecture_7/11.png" class="fig-75">}}
...
{{< collapsible title="A vivid example given by Gemini 2.5 pro." >}}
...
- contraction: for any $V$ and $\bar{V}$ , we have $\|\mathcal{B}V-\mathcal{B}\bar{V}\|\_\infin\leq\gamma\|V-\bar{V}\|\_\infin$
...
- $\mathcal{B}$ is a contraction w.r.t. $\infin$-norm ( “max” norm ), $\|\mathcal{B}V-\mathcal{B}\bar{V}\|\_{\infin}\leq\gamma\|V-\bar{V}\|\_{\infin}$
